# Aim: DESeq analysis of ZK vs OIL in Kidney
...
data <- read.csv(here(glue(dir, "data/GSE302870_S20193_alldata.tsv")),
                 row.names = 1, sep='\t')
metadata <- structure(list(Code = c("MNGC388", "MNGC425", "MNGC426", "MNGC427",
                                    "MNGC428", "MNGC429", "MNGC430"),
                           Name = c("s3_kid_122", "s1_kid_109_new",
                                     "s4_kid_135_new", "s5_kid_82_new",
                                    "s5_kid_83_new", "s7_kid_90_new",
                                     "s8_kid_139_new"),
                           condition = c("oil", "oil", "oil", "zk", "zk",
                                         "zk", "zk")), row.names = c(NA, 7L),
                      class = "data.frame")
